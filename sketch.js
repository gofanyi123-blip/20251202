...
function preload() {
  ...
  // ===================================
  npcSpriteSheet1 = loadImage('提問者1.png'); 
  npcSpriteSheet2 = loadImage('提問者2.png'); 
  npcSpriteSheet3 = loadImage('提問者3.png'); 
  helperSpriteSheet = loadImage('提示博士.png');
}
...
function setup() {
  ...
  // 提問者 NPC
  npcs.push(new NPC('提問者1', windowWidth / 4, windowHeight * 0.75, npcSpriteSheet1, 8, npc1FrameW, npc1FrameH));
  npcs.push(new NPC('提問者2', windowWidth / 2, windowHeight * 0.75, npcSpriteSheet2, 8, npc2FrameW, npc2FrameH));
  npcs.push(new NPC('提問者3', windowWidth * 0.75, windowHeight * 0.75, npcSpriteSheet3, 3, npc3FrameW, npc3FrameH));
...
function displayQuizInterface(nearNPC) {
    if (currentQuestion) {
        ...
        textAlign(CENTER);
        textSize(16);
        text(`按下 'E' 提問`, nearNPC.x, nearNPC.y - 80);
    }
}
